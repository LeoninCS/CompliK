...
type ComplikViolationEvent struct {
	...
	DeviceProfile string    `gorm:"size:32;index:idx_complik_device_time,priority:1"                                                                                                                                                                                   json:"device_profile,omitempty"`
	Viewport      string    `gorm:"size:64"                                                                                                                                                                                                                            json:"viewport,omitempty"`
	...
	DetectedAt    time.Time `gorm:"not null;index:idx_complik_namespace_time,priority:2;index:idx_complik_namespace_status_time,priority:3;index:idx_complik_detector_time,priority:2;index:idx_complik_host_time,priority:2;index:idx_complik_device_time,priority:2" json:"detected_at"`
...
func AutoMigrate(db *gorm.DB) error {
	if db == nil {
		return errors.New("complik violation automigrate: database is nil")
	}
